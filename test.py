...
if condition:
    if input_condition:
        folder = [
            ...
            "/home/shenss/python/dataset/lfw",
            "/home/shenss/python/dataset/lfw",
            "/home/shenss/python/dataset/lfw",
        ...
        folder = [
            ...
            "/home/shenss/python/dataset/VOC2012_ORI/train/fs",
            "/home/shenss/python/dataset/Celebrity Face Image Dataset/test/gt_256",
            "/home/shenss/python/dataset/Celebrity Face Image Dataset/test/Stucki_256",
        ]
    train_batch_size = 1
    num_samples = 1
    sum_scale = 1
...
trainer = Trainer(
    ...
    crop_patch=False,
    generation=False,
    halftone="evcs",  # None, fs, evcs, gmevcs
    gaussian_filter=3,
...
if not trainer.accelerator.is_local_main_process:
    ...
    epoch = 80
    trainer.load(epoch, load_name="DiffSo_GS3_TS5_80K_EVCS_Model")
    trainer.set_results_folder("./results/lfw/evcs")
    trainer.test(last=True, save_parent=True)  # save_parent 用于保存父文件夹
