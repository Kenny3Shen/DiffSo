...
if condition:
    if input_condition:
        ...
        folder = [
            "/home/shenss/python/dataset/VOC2012_ORI/train/gt",
            "/home/shenss/python/dataset/VOC2012_ORI/train/fs",
            "/home/shenss/python/dataset/celeba_hq_256_processed/original",
            "/home/shenss/python/dataset/celeba_hq_256_processed/original",
        ]
    train_batch_size = 1
    num_samples = 1
...
if not trainer.accelerator.is_local_main_process:
    ...
    epoch = 80
    trainer.load(epoch, load_name="RDDM_80K_GS3_TS5_EVCS_Model")
    trainer.set_results_folder("./results/RDDM_EVCS_CelebA/")
    trainer.test(last=True, save_parent=False)
